...
var b = (e, t, r) => (
    Ar(e, t, "read from private field"),
    r ? r.call(e) : t.get(e)
  ),
  F = (e, t, r) =>
    t.has(e)
      ? vn("Cannot add the same private member more than once")
      : t instanceof WeakSet
        ? t.add(e)
        : t.set(e, r),
  I = (e, t, r, n) => (
    Ar(e, t, "write to private field"),
    n ? n.call(e, r) : t.set(e, r),
    r
  ),
  re = (e, t, r) => (Ar(e, t, "access private method"), r);
var Yt = (e, t, r, n) => ({
  set _(o) {
    I(e, t, o, r);
  },
...
let Nr = 0;
function Qs() {
  return ((Nr = (Nr + 1) % Number.MAX_SAFE_INTEGER), Nr.toString());
}
const Sr = new Map(),
  xn = (e) => {
    if (Sr.has(e)) return;
 ...
 */
const Z = (e, t) => {
  const r = x.forwardRef(({ className: n, ...o }, s) =>
    x.createElement(ti, {
      ref: s,
      iconNode: t,
...
const ui = Z("Zap", [
  ...
  hi = (e) => {
    ...
    return {
      getClassGroupId: (i) => {
        const l = i.split(tn);
        return (l[0] === "" && l.length !== 1 && l.shift(), Co(l, t) || fi(i));
      },
  ...
  pi = (e) => {
    ...
    return (
      gi(Object.entries(e.classGroups), r).forEach(([s, i]) => {
        _r(i, n, s, t);
      }),
      n
    );
...
function ki(e, ...t) {
  ...
  function i(c) {
    ...
    return ((r = xi(d)), (n = r.cache.get), (o = r.cache.set), (s = l), l(c));
  }
  function l(c) {
    const d = n(c);
    if (d) return d;
...
const qi = Fs,
  So = x.forwardRef(({ className: e, ...t }, r) =>
    a.jsx(lo, {
      ref: r,
      className: ie(
...
const Ui = en(
  ...
  Eo = x.forwardRef(({ className: e, variant: t, ...r }, n) =>
    a.jsx(co, {
      ref: n,
      className: ie(
        Ui({
...
const Wi = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx(uo, {
    ref: r,
    className: ie(
...
const Po = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx(ho, {
    ref: r,
    className: ie(
...
const Oo = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx(fo, {
    ref: r,
...
const Mo = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx(po, {
    ref: r,
...
function Gi() {
  ...
  return a.jsxs(qi, {
    children: [
      e.map(function ({ id: t, title: r, description: n, action: o, ...s }) {
        return a.jsxs(
          Eo,
          {
            ...s,
...
function Ki() {
  ...
  Nn = 1;
  var e = Is();
  return ((Xt.createRoot = e.createRoot), (Xt.hydrateRoot = e.hydrateRoot), Xt);
}
var Qi = Ki(),
  Sn = ["light", "dark"],
...
x.memo(
  ({
    ...
    let d = s === "system",
      h =
        r === "class"
          ? `var d=document.documentElement,c=d.classList;${`c.remove(${l.map((m) => `'${m}'`).join(",")})`};`
      ...
      p = e
        ? `!function(){${h}${u(e)}}()`
        : n
          ? `!function(){try{${h}var e=localStorage.getItem('${t}');if('system'===e||(!e&&${d})){var t='${Yi}',m=window.matchMedia(t);if(m.media!==t||m.matches){${u("dark")}}else{${u("light")}}}else if(e){${i ? `var x=${JSON.stringify(i)};` : ""}${u(i ? "x[e]" : "e", !0)}}${d ? "" : "else{" + u(s, !1, !1) + "}"}${f}}catch(e){}}()`
          : `!function(){try{${h}var e=localStorage.getItem('${t}');if(e){${i ? `var x=${JSON.stringify(i)};` : ""}${u(i ? "x[e]" : "e", !0)}}else{${u(s, !1, !1)};}${f}}catch(t){}}();`;
...
var ja = (e) => {
  ...
  let {
    ...
    Kt = C.useMemo(
      () => y.findIndex((M) => M.toastId === u.id) || 0,
      [y, u.id],
    ),
    Ns = C.useMemo(() => {
      var M;
    ...
    [mn, Ss] = z.split("-"),
    gn = C.useMemo(
      () => y.reduce((M, K, U) => (U >= Kt ? M : M + K.height), 0),
      [y, Kt],
    ),
    yn = aa(),
    Es = u.invert || f,
  ...
  (C.useEffect(() => {
    ...
    return (
      k || m || (O && yn)
        ...
        : K !== 1 / 0 &&
          ((kr.current = new Date().getTime()),
          (M = setTimeout(() => {
            var U;
            ((U = u.onAutoClose) == null || U.call(u, u), De());
          }, K))),
      () => clearTimeout(M)
    );
  ...
  return C.createElement(
    "li",
    {
      ...
      className: q(
        ...
        A == null ? void 0 : A[te],
        (r = u == null ? void 0 : u.classNames) == null ? void 0 : r[te],
      ),
      "data-sonner-toast": "",
      ...
      onPointerUp: () => {
        ...
        let xe = Number(
          ...
          Qt =
            new Date().getTime() -
            ((K = Gt.current) == null ? void 0 : K.getTime()),
          Os = Math.abs(xe) / Qt;
        if (Math.abs(xe) >= ba || Os > 0.11) {
          (nt(st.current),
        ...
        ((be = Le.current) == null ||
          be.style.setProperty("--swipe-amount", "0px"),
          Me(!1));
      },
      onPointerMove: (M) => {
        var K;
        if (!it.current || !ot) return;
        ...
        Math.abs(xe) > Qt
          ? (K = Le.current) == null ||
            K.style.setProperty("--swipe-amount", `${U}px`)
          : Math.abs(be) > Qt && (it.current = null);
      },
    },
    Ns && !u.jsx
      ? C.createElement(
          "button",
          {
            ...
            onClick:
              Tr || !ot
                ...
                : () => {
                    var M;
                    (De(), (M = u.onDismiss) == null || M.call(u, u));
                  },
            className: q(
      ...
      : null,
    u.jsx || C.isValidElement(u.title)
      ? u.jsx || u.title
      : C.createElement(
          C.Fragment,
          null,
          te || u.icon || u.promise
            ? C.createElement(
                ...
                u.promise || (u.type === "loading" && !u.icon)
                  ...
                  : null,
                u.type !== "loading"
                  ? u.icon || (H == null ? void 0 : H[te]) || ea(te)
                  : null,
              )
            : null,
          C.createElement(
          ...
          C.isValidElement(u.cancel)
            ? u.cancel
            : u.cancel && Jt(u.cancel)
              ? C.createElement(
                  "button",
                  {
                    "data-button": !0,
                    ...
                    onClick: (M) => {
                      ...
                      Jt(u.cancel) &&
                        ot &&
                        ((U = (K = u.cancel).onClick) == null || U.call(K, M),
                        De());
                    },
                    className: q(
              ...
              : null,
          C.isValidElement(u.action)
            ? u.action
            : u.action && Jt(u.action)
              ? C.createElement(
                  "button",
                  {
                    "data-button": !0,
                    ...
                    onClick: (M) => {
                      ...
                      Jt(u.action) &&
                        (M.defaultPrevented ||
                          ((U = (K = u.action).onClick) == null || U.call(K, M),
                          De()));
                    },
                    className: q(
                      A == null ? void 0 : A.actionButton,
                      (h = u == null ? void 0 : u.classNames) == null
                        ? void 0
                        : h.actionButton,
                    ),
                  },
...
var Ca = (e) => {
  let {
    ...
    L = C.useMemo(
      () =>
        Array.from(
          new Set(
            [r].concat(T.filter((O) => O.position).map((O) => O.position)),
          ),
        ),
      [T, r],
    ),
    ...
    ee = C.useCallback(
      (O) => {
        var q;
        (((q = T.find((G) => G.id === O.id)) != null && q.delete) ||
          le.dismiss(O.id),
  ...
  return (
    ...
    C.useEffect(() => {
      let O = (q) => {
        var G, ue;
        (n.every((Ae) => q[Ae] || q.code === Ae) &&
          (_(!0), (G = D.current) == null || G.focus()),
          q.code === "Escape" &&
      ...
      ? C.createElement(
          ...
          L.map((O, q) => {
            ...
            return C.createElement(
              "ol",
              {
                ...
                onFocus: (J) => {
                  (J.target instanceof HTMLElement &&
                    ...
                    H.current ||
                    ((H.current = !0), (A.current = J.relatedTarget));
                },
                onMouseEnter: () => _(!0),
                onMouseMove: () => _(!0),
                onMouseLeave: () => {
              ...
              T.filter((J) => (!J.position && q === 0) || J.position === O).map(
                (J, rt) => {
                  var Me, Re;
                  return C.createElement(ja, {
                    ...
                    defaultRichColors: d,
                    duration:
                      (Me = p == null ? void 0 : p.duration) != null ? Me : h,
...
function Ra(e, t, r, n) {
  ...
  return (
    o && ((s = s.map((i) => i + "-" + o)), t && (s = s.concat(s.map(qr)))),
    s
  );
}
function dr(e) {
...
async function Dt(e, t) {
  ...
  const { x: n, y: o, platform: s, rects: i, elements: l, strategy: c } = e,
    ...
    k = (await (s.isElement == null ? void 0 : s.isElement(j)))
      ? (await (s.getScale == null ? void 0 : s.getScale(j))) || {
          x: 1,
          y: 1,
        }
      : {
...
const Da = (e) => ({
    ...
    async fn(t) {
      ...
      let L = N ? N[j] : 0;
      (!L || !(await (i.isElement == null ? void 0 : i.isElement(N)))) &&
        (L = l.floating[j] || s.floating[m]);
      const S = k / 2 - T / 2,
        $ = L / 2 - g[m] / 2 - 1,
        W = Ue(f[y], $),
        _ = Ue(f[w], $),
        ...
        D =
          ...
          Nt(o) != null &&
          z !== Y &&
          s.reference[m] / 2 - (z < E ? W : _) - g[m] / 2 < 0,
        V = D ? (z < E ? z - E : z - B) : 0;
      return {
        [p]: u[p] + V,
        data: {
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          if (
            ...
            let D =
              (E = W.filter((V) => V.overflows[0] <= 0).sort(
                (V, A) => V.overflows[1] - A.overflows[1],
              )[0]) == null
                ? void 0
                : E.placement;
            if (!D)
          ...
          if (d) {
            ...
            const j = u === "y" ? "width" : "height",
              ...
              T =
                s.reference[f] -
                s.floating[j] +
                ((k && ((y = i.offset) == null ? void 0 : y[f])) || 0) +
                (k ? 0 : v.crossAxis),
              N =
                s.reference[f] +
                s.reference[j] +
                (k ? 0 : ((w = i.offset) == null ? void 0 : w[f]) || 0) -
                (k ? v.crossAxis : 0);
            m < T ? (m = T) : m > N && (m = N);
          }
          return {
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          let L = k,
            S = T;
          if (
            ((r = t.middlewareData.shift) != null && r.enabled.x && (S = j),
            ...
            const W = ce(h.left, 0),
              ...
              B = ce(h.bottom, 0);
            p
              ? (S = m - 2 * (W !== 0 || _ !== 0 ? W + _ : ce(h.left, h.right)))
              : (L =
                  g - 2 * (E !== 0 || B !== 0 ? E + B : ce(h.top, h.bottom)));
          }
          await c({
            ...t,
            availableWidth: S,
...
function Ka(e) {
  ...
  if (
    (f || (!f && !s)) &&
    ((St(n) !== "body" || qt(i)) && (c = yr(n)), ke(n))
  ) {
    const u = tt(n);
    ((d = ht(n)), (h.x = u.x + n.clientLeft), (h.y = u.y + n.clientTop));
  }
  return {
    width: r.width * d.x,
    height: r.height * d.y,
...
function Ya(e) {
  ...
  const l = -r.scrollTop;
  return (
    ve(n).direction === "rtl" && (i += ce(t.clientWidth, n.clientWidth) - o),
    {
      width: o,
      height: s,
      x: i,
...
function In(e, t, r) {
  let n;
  if (t === "viewport") n = Xa(e, r);
  else if (t === "document") n = Ya(Te(e));
  else if (ye(t)) n = Ja(t, r);
  else {
    const o = Ho(e);
    n = {
      ...t,
...
function $o(e, t) {
  const r = Ke(e);
  return r === t || !ye(r) || kt(r)
    ? !1
    : ve(r).position === "fixed" || $o(r, t);
}
function Za(e, t) {
  const r = t.get(e);
  if (r) return r;
...
function rl(e, t, r) {
  ...
  if (o && !n && !s) {
    ...
    ((h = p.top + l.scrollTop), (d = p.left + l.scrollLeft - Wr(o, p)));
  }
...
function Ln(e, t) {
  if (!ke(e) || ve(e).position === "fixed") return null;
  if (t) return t(e);
...
function zo(e, t) {
  ...
  if (!ke(e)) {
    let o = Ke(e);
    for (; o && !kt(o); ) {
      if (ye(o) && !Pr(o)) return o;
      o = Ke(o);
    }
    return r;
  }
  let n = Ln(e, t);
  for (; n && qa(n) && Pr(n); ) n = Ln(n, t);
...
function hr(e, t) {
  ...
  if (e && t && typeof e == "object") {
    if (Array.isArray(e)) {
      ...
      for (n = r; n-- !== 0; ) if (!hr(e[n], t[n])) return !1;
      return !0;
    }
    ...
    for (n = r; n-- !== 0; ) {
      const s = o[n];
      if (!(s === "_owner" && e.$$typeof) && !hr(e[s], t[s])) return !1;
    }
    return !0;
  }
  return e !== e && t !== t;
...
function ml(e) {
  ...
  (ar(
    ...
    ar(() => {
      if ((k && (N.current = k), T && (L.current = T), k && T)) {
        if (W.current) return W.current(k, T, B);
        B();
      }
    }, [k, T, B, W, $]));
  const Y = x.useMemo(
      ...
      a.jsx("div", {
        ...
        style: {
          ...
          "--radix-popper-transform-origin": [
            (Ie = A.transformOrigin) == null ? void 0 : Ie.x,
  ...
  fn(t) {
    ...
    return (
      d === "bottom"
        ? ((m = i ? f : `${u}px`), (g = `${-c}px`))
        : d === "top"
          ? ((m = i ? f : `${u}px`), (g = `${n.floating.height + c}px`))
          : d === "right"
            ? ((m = `${-c}px`), (g = i ? f : `${p}px`))
            : d === "left" &&
              ((m = `${n.floating.width + c}px`), (g = i ? f : `${p}px`)),
      {
        data: {
          x: m,
          y: g,
        ...
        if (i) {
          const m = (g) => {
            const v = g.target,
              ...
              w =
                (c == null ? void 0 : c.contains(v)) ||
                (h == null ? void 0 : h.contains(v)),
              j = !Yl(y, i);
            w ? u() : j && (u(), d());
          };
          return (
...
var Zl = ts,
  is = ns;
const ec = Zl,
  tc = x.forwardRef(({ className: e, sideOffset: t = 4, ...r }, n) =>
    a.jsx(is, {
      ref: n,
      sideOffset: t,
      className: ie(
...
function Fn(e, t) {
  ...
  if (i) {
    if (n) {
      if (t.queryHash !== un(i, t.options)) return !1;
    } else if (!zt(t.queryKey, i)) return !1;
  }
  if (r !== "all") {
    const c = t.isActive();
...
function _n(e, t) {
  ...
  if (s) {
    ...
    if (r) {
      if ($t(t.options.mutationKey) !== $t(s)) return !1;
    } else if (!zt(t.options.mutationKey, s)) return !1;
  }
  ...
  return e === t
    ...
    : typeof e != typeof t
      ...
      : e && t && typeof e == "object" && typeof t == "object"
        ? !Object.keys(t).some((r) => !zt(e[r], t[r]))
        : !1;
}
function as(e, t) {
  if (e === t) return e;
  ...
  if (r || (Kr(e) && Kr(t))) {
    ...
    for (let d = 0; d < i; d++) {
      const h = r ? d : s[d];
      ((!r && n.includes(h)) || r) && e[h] === void 0 && t[h] === void 0
        ? ((l[h] = void 0), c++)
        : ((l[h] = as(e[h], t[h])), l[h] === e[h] && e[h] !== void 0 && c++);
    }
    return o === i && c === o ? e : l;
  }
  return t;
  ...
  dc =
    ((eo = class extends xr {
      ...
      onUnsubscribe() {
        var t;
        this.hasListeners() ||
          ((t = b(this, Fe)) == null || t.call(this), I(this, Fe, void 0));
      }
      setEventListener(t) {
        var r;
        (I(this, mt, t),
      ...
      setFocused(t) {
        b(this, Ye) !== t && (I(this, Ye, t), this.onFocus());
      }
      onFocus() {
      ...
      isFocused() {
        var t;
        return typeof b(this, Ye) == "boolean"
          ? b(this, Ye)
  ...
  uc =
    ((to = class extends xr {
      ...
      onUnsubscribe() {
        var t;
        this.hasListeners() ||
          ((t = b(this, _e)) == null || t.call(this), I(this, _e, void 0));
      }
      setEventListener(t) {
        var r;
        (I(this, yt, t),
...
function fs(e) {
  ...
  const l = new Promise((y, w) => {
    ...
    c = (y) => {
      var w;
      n || (m(new hs(y)), (w = e.abort) == null || w.call(e));
    },
    d = () => {
      t = !0;
    },
    ...
    f = () =>
      ds.isFocused() &&
      (e.networkMode === "always" || fr.isOnline()) &&
      e.canRun(),
    ...
    g = () =>
      new Promise((y) => {
        ...
        var y;
        ((o = void 0), n || (y = e.onContinue) == null || y.call(e));
      }),
    v = () => {
      if (n) return;
      let y;
...
var se = fc(),
  ...
  ps =
    ((ro = class {
      ...
      clearGcTimeout() {
        b(this, Xe) && (clearTimeout(b(this, Xe)), I(this, Xe, void 0));
      }
    }),
    (Xe = new WeakMap()),
    ro),
  ...
  pc =
    ((no = class extends ps {
      ...
      reset() {
        (this.destroy(), this.setState(b(this, vt)));
      }
      isActive() {
      ...
      fetch(t, r) {
        ...
        const l = (f) => {
          ...
          ((Mr(f) && f.silent) ||
            ...
            Mr(f) ||
              ((p = (u = b(this, fe).config).onError) == null ||
                p.call(u, f, this),
              (g = (m = b(this, fe).config).onSettled) == null ||
                g.call(m, this.state.data, f, this)),
          ...
          I(
            ...
            fs({
              ...
              onSuccess: (f) => {
                ...
                ((p = (u = b(this, fe).config).onSuccess) == null ||
                  p.call(u, f, this),
                  (g = (m = b(this, fe).config).onSettled) == null ||
                    g.call(m, f, this.state.error, this),
                  this.isFetchingOptimistic || this.scheduleGc(),
                  (this.isFetchingOptimistic = !1));
              },
              onError: l,
  ...
  yc =
    ((oo = class extends xr {
      constructor(t = {}) {
        super();
        F(this, we);
        ((this.config = t), I(this, we, new Map()));
      }
      build(t, r, n) {
        const o = r.queryKey,
      ...
      add(t) {
        b(this, we).has(t.queryHash) ||
          (b(this, we).set(t.queryHash, t),
          this.notify({
            type: "added",
            query: t,
          }));
  ...
  vc =
    ((so = class extends ps {
      ...
      continue() {
        var t;
        return (
          ((t = b(this, Ze)) == null ? void 0 : t.continue()) ??
        ...
        try {
          if (!r) {
            (re(this, Ce, ze).call(this, {
              ...
              await ((s = (o = b(this, oe).config).onMutate) == null
                ? void 0
                : s.call(o, t, this)));
            const $ = await ((l = (i = this.options).onMutate) == null
              ? void 0
              : l.call(i, t));
            $ !== this.state.context &&
              re(this, Ce, ze).call(this, {
          ...
          return (
            await ((d = (c = b(this, oe).config).onSuccess) == null
              ? void 0
              : d.call(c, S, t, this.state.context, this)),
            await ((f = (h = this.options).onSuccess) == null
              ? void 0
              : f.call(h, S, t, this.state.context)),
            await ((p = (u = b(this, oe).config).onSettled) == null
              ? void 0
              : p.call(
                  u,
                  S,
            ...
            await ((g = (m = this.options).onSettled) == null
              ? void 0
              : g.call(m, S, null, t, this.state.context)),
            re(this, Ce, ze).call(this, {
              type: "success",
              data: S,
            }),
          ...
          try {
            throw (
              await ((y = (v = b(this, oe).config).onError) == null
                ? void 0
                : y.call(v, S, t, this.state.context, this)),
              await ((j = (w = this.options).onError) == null
                ? void 0
                : j.call(w, S, t, this.state.context)),
              await ((T = (k = b(this, oe).config).onSettled) == null
                ? void 0
                : T.call(
                    k,
                    void 0,
              ...
              await ((L = (N = this.options).onSettled) == null
                ? void 0
                : L.call(N, void 0, S, t, this.state.context)),
              S
            );
          } finally {
            re(this, Ce, ze).call(this, {
  ...
  xc =
    ((io = class extends xr {
      constructor(t = {}) {
        ...
        F(this, ae);
        F(this, Bt);
        ((this.config = t), I(this, ae, new Map()), I(this, Bt, Date.now()));
      }
      build(t, r, n) {
        const o = new vc({
          mutationCache: this,
      ...
      canRun(t) {
        var n;
        const r =
          (n = b(this, ae).get(tr(t))) == null
            ? void 0
            : n.find((o) => o.state.status === "pending");
        return !r || r === t;
      }
      runNext(t) {
        var n;
      ...
      resumePausedMutations() {
        ...
        return se.batch(() =>
          Promise.all(t.map((r) => r.continue().catch(pe))),
        );
      }
    }),
    (ae = new WeakMap()),
  ...
  return {
    onFetch: (t, r) => {
      ...
      const n = t.options,
        o =
          (u =
            (f = (h = t.fetchOptions) == null ? void 0 : h.meta) == null
              ? void 0
              : f.fetchMore) == null
            ? void 0
            : u.direction,
      ...
      const d = async () => {
        ...
        const v = (j) => {
          ...
          w = async (j, k, T) => {
            ...
            if (k == null && j.pages.length) return Promise.resolve(j);
            const N = {
              queryKey: t.queryKey,
              pageParam: k,
      ...
      t.options.persister
        ? (t.fetchFn = () => {
            var g, v;
            return (v = (g = t.options).persister) == null
              ? void 0
              : v.call(
                  g,
                  d,
  ...
  jc =
    ((ao = class {
          ...
          b(this, qe) === 1 &&
            (I(
              ...
              ds.subscribe(async (e) => {
                e && (await this.resumePausedMutations(), b(this, X).onFocus());
              }),
            ),
            I(
              this,
              ...
              fr.subscribe(async (e) => {
                e &&
                  (await this.resumePausedMutations(), b(this, X).onOnline());
              }),
            )));
      }
      unmount() {
      ...
      getQueryData(e) {
        ...
        return (r = b(this, X).get(t.queryHash)) == null
          ? void 0
          : r.state.data;
      }
      ensureQueryData(e) {
        ...
        if (t === void 0) return this.fetchQuery(e);
        {
          ...
          return (
            e.revalidateIfStale &&
              n.isStaleByTime(zn(r.staleTime, n)) &&
      ...
      fetchQuery(e) {
        ...
        return r.isStaleByTime(zn(t.staleTime, r))
          ? r.fetch(t)
      ...
      fetchInfiniteQuery(e) {
        return ((e.behavior = qn(e.pages)), this.fetchQuery(e));
      }
      prefetchInfiniteQuery(e) {
        return this.fetchInfiniteQuery(e).then(pe).catch(pe);
      }
      ensureInfiniteQueryData(e) {
        return ((e.behavior = qn(e.pages)), this.ensureQueryData(e));
      }
      resumePausedMutations() {
        return fr.isOnline()
          ? b(this, Be).resumePausedMutations()
          : Promise.resolve();
      }
      getQueryCache() {
        return b(this, X);
      ...
      defaultQueryOptions(e) {
        ...
        return (
          t.queryHash || (t.queryHash = un(t.queryKey, t)),
      ...
      clear() {
        (b(this, X).clear(), b(this, Be).clear());
      }
    }),
    (X = new WeakMap()),
    (Be = new WeakMap()),
    ...
    (Ct = new WeakMap()),
    ao),
  Cc = x.createContext(void 0),
  kc = ({ client: e, children: t }) => (
    x.useEffect(
      () => (
        e.mount(),
        () => {
...
const Tc = {
    en: {
      ...
      "hero.subtitle":
        "Creating meaningful technology that connects and empowers people",
      "hero.description":
        "A young programmer with a different mindset and a desire to create real value from technology. I began my journey with the first lines of code — not just to write software, but to rewrite the way people connect, learn, and grow.",
      "hero.belief":
        "I believe that: Technology is not here to replace humans — it's here to free us from old limitations.",
      "hero.goal":
        "🎯 My goal is not only to build powerful tools, but also to craft an architecture that nurtures a space where knowledge, creativity, and efficiency grow in harmony.",
      "hero.journey":
        "🌱 Every moment is progress, every project is a journey, and every failure is a lesson. I choose to live with technology — but never let it confine the freedom of thought.",
      ...
      "about.learning.desc":
        "Embracing new technologies and methodologies to stay ahead",
      ...
      "about.beyond.text1":
        "When I'm not coding, I enjoy exploring cybersecurity research, staying updated with the latest tech trends, and contributing to the developer community.",
      "about.beyond.text2":
        "I believe in the power of automation to transform workflows and make technology more accessible to everyone.",
      ...
      "tech.subtitle":
        "Crafting digital solutions with modern technologies and innovative approaches",
      ...
      "projects.subtitle":
        "Specialized tools showcasing expertise in automation, reverse engineering, and security research",
      ...
      "contact.subtitle":
        "Ready to collaborate on innovative projects or discuss automation solutions? Let's connect and build something impactful together!",
    ...
    vi: {
      ...
      "hero.subtitle":
        "Tạo ra công nghệ có ý nghĩa kết nối và trao quyền cho mọi người",
      "hero.description":
        "Một lập trình viên trẻ mong muốn tạo ra giá trị thực từ công nghệ. Tôi bắt đầu hành trình với những dòng code đầu tiên — không chỉ để viết phần mềm, mà để viết lại cách mọi người kết nối, học hỏi và phát triển.",
      "hero.belief":
        "Tôi tin rằng: Công nghệ không có ở đây để thay thế con người — nó ở đây để giải phóng chúng ta khỏi những giới hạn cũ.",
      "hero.goal":
        "🎯 Mục tiêu của tôi không chỉ là xây dựng những công cụ mạnh mẽ, mà còn tạo ra một kiến trúc nuôi dưỡng không gian nơi kiến thức, sáng tạo và hiệu quả phát triển hài hòa.",
      "hero.journey":
        "🌱 Mỗi khoảnh khắc là tiến bộ, mỗi dự án là hành trình, và mỗi thất bại là bài học. Tôi chọn sống cùng công nghệ — nhưng không bao giờ để nó giới hạn tự do tư tưởng.",
      "hero.quote":
        '⏳ "Giải pháp không nằm trong code — nó nằm trong cách chúng ta suy nghĩ về vấn đề."',
      "about.title": "Giới thiệu",
      "about.subtitle":
        "Đam mê tạo ra những giải pháp sáng tạo và đẩy lùi ranh giới của công nghệ",
      "about.philosophy": "Triết lý & Giá trị",
      "about.beyond": "Ngoài Code",
      "about.learning": "Học hỏi liên tục",
      "about.learning.desc":
        "Tiếp thu công nghệ và phương pháp mới để luôn dẫn đầu",
      ...
      "about.beyond.text1":
        "Khi không code, tôi thích khám phá nghiên cứu an ninh mạng, cập nhật xu hướng công nghệ mới nhất, và đóng góp cho cộng đồng developer.",
      "about.beyond.text2":
        "Tôi tin vào sức mạnh của tự động hóa để biến đổi quy trình làm việc và làm cho công nghệ dễ tiếp cận hơn với mọi người.",
      "about.beyond.exploring": "Luôn khám phá những khả năng mới",
      "journey.title": "Hành trình hiện tại",
      "journey.item1":
        "• Khám phá giao điểm giữa công nghệ và tiềm năng con người",
      ...
      "tech.subtitle":
        "Tạo ra giải pháp số với công nghệ hiện đại và cách tiếp cận sáng tạo",
      ...
      "projects.subtitle":
        "Công cụ chuyên biệt thể hiện chuyên môn trong tự động hóa, reverse engineering và nghiên cứu bảo mật",
      "projects.featured": "⭐ Nổi bật",
      "projects.source": "Mã nguồn",
      "projects.view": "Xem dự án",
      "projects.interested":
        "Quan tâm đến việc hợp tác hoặc tìm hiểu thêm về công việc của tôi?",
      "projects.explore": "Khám phá tất cả dự án",
      "contact.title": "Kết nối với tôi",
      "contact.subtitle":
        "Sẵn sàng hợp tác trong các dự án sáng tạo hoặc thảo luận về giải pháp tự động hóa? Hãy kết nối và cùng xây dựng điều gì đó có tác động!",
      "contact.github": "GitHub",
      "contact.youtube": "YouTube",
      "contact.email": "Email",
...
function Ac({ children: e }) {
  ...
  const n = (s) => {
      (r(s), localStorage.setItem("language", s));
    },
    o = (s) => Tc[t][s] || s;
  ...
  function o(s, i) {
    ...
    if (s && i && typeof s == "object" && typeof i == "object") {
      ...
      if (Array.isArray(s)) {
        ...
        for (c = l; c-- !== 0; ) if (!o(s[c], i[c])) return !1;
        return !0;
      }
      var h;
      ...
      if (n && ArrayBuffer.isView(s) && ArrayBuffer.isView(i)) {
        if (((l = s.length), l != i.length)) return !1;
        for (c = l; c-- !== 0; ) if (s[c] !== i[c]) return !1;
        return !0;
      }
      ...
      if (((d = Object.keys(s)), (l = d.length), l !== Object.keys(i).length))
        return !1;
      for (c = l; c-- !== 0; )
  ...
  return (
    Qn ||
      ...
      (Lr = function (t, r, n, o) {
        ...
        for (
          var c = Object.prototype.hasOwnProperty.bind(r), d = 0;
          d < i.length;
          d++
        ) {
          var h = i[d];
...
var gs = ((e) => (
  ...
  Lc = Object.entries(hn).reduce((e, [t, r]) => ((e[r] = t), e), {}),
  ge = "data-rh",
  ft = {
  ...
  zc = (e) => console && typeof console.warn == "function" && console.warn(e),
  Mt = (e, t, r) => {
    const n = {};
    return r
      .filter((o) =>
        ...
        s.filter((c) => {
          ...
          for (let u = 0; u < h.length; u += 1) {
            ...
            (t.indexOf(m) !== -1 &&
              ...
              !(m === "rel" && c[m].toLowerCase() === "stylesheet") &&
              (d = m),
              t.indexOf(p) !== -1 &&
  ...
  $r = (e, t) =>
    Array.isArray(e)
      ? e.reduce(
          (r, n) => (Bc(n, t) ? r.priority.push(n) : r.default.push(n), r),
          {
            priority: [],
            default: [],
          },
    ...
    return {
      priorityMethods: {
        toComponent: () => [
          ...lr("meta", o.priority),
          ...lr("link", s.priority),
          ...lr("script", i.priority),
        ],
        toString: () =>
          `${he("meta", o.priority, n)} ${he("link", s.priority, n)} ${he("script", i.priority, n)}`,
      },
      metaTags: o.default,
      linkTags: s.default,
        ...
        t.forEach((l) => {
          ...
          for (const d in l)
            if (Object.prototype.hasOwnProperty.call(l, d))
              if (d === "innerHTML") c.innerHTML = l.innerHTML;
              else if (d === "cssText")
                c.styleSheet
          ...
          (c.setAttribute(ge, "true"),
            o.some((d, h) => ((i = h), c.isEqualNode(d)))
              ? o.splice(i, 1)
              : s.push(c));
        }),
      o.forEach((l) => {
  ...
  Jr = (e, t) => {
    ...
    for (let l = s.length - 1; l >= 0; l -= 1) r.removeAttribute(s[l]);
    o.length === s.length
      ? r.removeAttribute(ge)
      : r.getAttribute(ge) !== i.join(",") && r.setAttribute(ge, i.join(","));
  },
  Yc = (e, t) => {
  ...
  Jn = (e, t) => {
    ...
    (Object.keys(p).forEach((v) => {
      ...
      (y.length && (m[v] = y), w.length && (g[v] = p[v].oldTags));
    }),
      t && t(),
      c(e, m, g));
  },
  ...
  Zn = class extends x.Component {
    ...
    emitChange() {
      ...
      (js.canUseDOM ? Jc(o) : Yr && (n = Yr(o)), r(n));
    }
    init() {
    ...
    ((Fr = class extends x.Component {
        ...
        return (
          Kn(
            ...
            typeof e.type == "function"
              ...
              : `Only elements types ${Yn.join(", ")} are allowed. Helmet does not support rendering <${e.type}> elements. Refer to our API for more information.`,
          ),
          Kn(
            !t ||
              typeof t == "string" ||
        ...
        return (
          C.Children.forEach(e, (n) => {
            ...
            switch (
              (typeof l == "symbol"
                ? (l = l.toString())
                : this.warnOnInvalidChildren(n, o),
              l)
            ) {
      ...
      render() {
        ...
        let r = {
          ...
          { helmetData: n } = t;
        if (
          (e && (r = this.mapChildrenToProps(e, r)), n && !(n instanceof Xr))
        ) {
          const o = n;
          ((n = new Xr(o.context, !0)), delete r.helmetData);
        }
        return n
          ? C.createElement(Zn, {
              ...r,
          ...
          : C.createElement(ws.Consumer, null, (o) =>
              C.createElement(Zn, {
                ...r,
                context: o,
              }),
...
const ct = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx("div", {
    ref: r,
    className: ie(
...
ct.displayName = "Card";
const ed = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx("div", {
    ref: r,
...
const td = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx("h3", {
    ref: r,
...
const rd = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx("p", {
    ref: r,
...
const dt = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx("div", {
    ref: r,
...
const nd = x.forwardRef(({ className: e, ...t }, r) =>
  a.jsx("div", {
    ref: r,
...
function sd() {
  ...
  return a.jsxs(P.button, {
    onClick: n,
    className:
      "flex items-center space-x-2 px-3 py-2 rounded-lg border border-border/50 hover:border-primary/50 transition-all duration-300 bg-card/30 backdrop-blur-sm group smooth-hover",
    whileHover: {
      scale: 1.05,
    },
    whileTap: {
...
function ks({
  title:
    e = "Ngo Quang Duan | Lập trình viên trẻ chuyên về tự động hóa & nghiên cứu bảo mật",
  description:
    t = "Ngo Quang Duan - Lập trình viên trẻ đam mê về tự động hóa, học máy và nghiên cứu bảo mật. Khám phá các dự án sáng tạo và giải pháp công nghệ.",
  keywords:
    r = "Ngo Quang Duan, Ngo Quang Duan, lập trình viên, tự động hóa, reverse engineering, nghiên cứu bảo mật, Python, JavaScript, blockchain, AI, học máy",
  ogImage: n = "/avata.png",
  ogUrl: o = "https://ngoquangduan.io.vn",
  ogType: s = "website",
  twitterCard: i = "summary_large_image",
  noIndex: l = !1,
  canonicalUrl: c,
  lang: d = "vi",
}) {
...
function id({
  ...
  description: t,
  image: r = "/avata.png",
  url: n = "https://ngoquangduan.io.vn",
  sameAs: o = [
    "https://github.com/hiep-py",
    "https://www.youtube.com/@LacDev-db2vx",
  ],
    ...
    children: [
      a.jsxs("div", {
        ...
        children: [
          ...
          a.jsx("div", {
            className:
              "absolute top-0 -left-4 w-72 h-72 bg-primary/20 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob",
          }),
          a.jsx("div", {
            className:
              "absolute top-0 -right-4 w-72 h-72 bg-accent/20 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000",
          }),
          a.jsx("div", {
            className:
              "absolute -bottom-8 left-20 w-72 h-72 bg-primary/10 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000",
          }),
        ],
      }),
      a.jsx("div", {
        ...
        children: a.jsxs("div", {
          ...
          children: [
            a.jsxs("div", {
              ...
              children: [
                a.jsxs(P.div, {
                  ...
                  className:
                    "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-mono mb-8 mx-auto lg:mx-0",
                  children: [
                    a.jsxs("span", {
                ...
                a.jsxs(P.h1, {
                  ...
                  className:
                    "text-5xl lg:text-8xl font-bold tracking-tight leading-[1.1] mb-6",
                  children: [
                    t === "en" ? "Hello, I'm " : "Xin chào, tôi là ",
                    a.jsx("span", {
                      className:
                ...
                a.jsx(P.div, {
                  ...
                  children: a.jsx("p", {
                    className:
                      "text-xl lg:text-3xl text-muted-foreground font-light font-mono",
                ...
                a.jsxs(P.div, {
                  ...
                  children: [
                    a.jsx("div", {
                      className:
                        "absolute -inset-0.5 bg-gradient-to-r from-primary to-accent rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-1000",
                    }),
                    a.jsxs("div", {
                      className:
                        "relative bg-card/80 backdrop-blur-sm border border-border rounded-xl p-6 shadow-xl",
                      children: [
                        a.jsxs("div", {
                          className:
                            "flex items-center gap-2 mb-3 border-b border-border pb-3",
                          children: [
                            a.jsxs("div", {
                              ...
                              children: [
                                a.jsx("div", {
                                  className:
                                    "w-2.5 h-2.5 rounded-full bg-red-500/50",
                                }),
                                a.jsx("div", {
                                  className:
                                    "w-2.5 h-2.5 rounded-full bg-yellow-500/50",
                                }),
                                a.jsx("div", {
                                  className:
                                    "w-2.5 h-2.5 rounded-full bg-green-500/50",
                                }),
                              ],
                            }),
                            a.jsx("span", {
                        ...
                        a.jsx("p", {
                          className:
                            "text-foreground text-lg leading-relaxed font-light",
                ...
                a.jsxs(P.div, {
                  ...
                  className:
                    "flex flex-col sm:flex-row items-center gap-4 mt-10 justify-center lg:justify-start",
                  children: [
                    a.jsx(P.div, {
                      whileHover: {
                        scale: 1.05,
                      ...
                      children: a.jsx(Ft, {
                        ...
                        children: a.jsxs("a", {
                          ...
                          children: [
                            a.jsx("div", {
                              className:
                                "absolute inset-0 w-full h-full bg-gradient-to-r from-primary via-accent to-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300",
                            }),
                            a.jsxs("span", {
                    ...
                    a.jsx("div", {
                      ...
                      children: ad.map(({ icon: r, href: n, labelKey: o }) =>
                        a.jsx(
                          P.a,
                          {
                            href: n,
            ...
            a.jsx(P.div, {
              ...
              children: a.jsxs("div", {
                className:
                  "relative w-[300px] h-[300px] lg:w-[450px] lg:h-[450px]",
                children: [
                  a.jsx("div", {
                    className:
                  ...
                  a.jsx("div", {
                    className:
                      "absolute inset-4 border border-accent/20 rounded-full animate-[spin_15s_linear_infinite_reverse]",
                  }),
                  a.jsx("div", {
                    className:
                      "absolute inset-0 rounded-full bg-gradient-to-br from-primary/10 to-accent/10 blur-3xl",
                  }),
                  a.jsxs("div", {
                    className:
                      "absolute inset-8 bg-card rounded-full border-2 border-border overflow-hidden shadow-2xl z-10 group",
                    children: [
                      a.jsx("div", {
                        className:
                          "absolute inset-0 bg-gradient-to-tr from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20",
                      }),
                      a.jsxs("a", {
                        href: "/avatar.png",
                        children: [
                          a.jsx("img", {
                            ...
                            alt: "Ngo Quang Duan",
                            className:
                              "w-full h-full object-cover scale-110 group-hover:scale-100 transition-transform duration-700",
                          }),
                        ],
                      }),
                    ],
                  ...
                  a.jsx(P.div, {
                    ...
                    className:
                      "absolute top-10 -right-4 bg-card/90 backdrop-blur-md border border-accent/30 p-3 rounded-lg shadow-xl z-20",
                    children: a.jsx(wo, {
      ...
      a.jsx("div", {
        ...
        children:
          t === "en"
            ? "As a dedicated developer specializing in automation, machine learning, and security research, I combine technical expertise with innovative problem-solving to deliver impactful solutions across various domains."
            : "Là một lập trình viên chuyên về tự động hóa, học máy và nghiên cứu bảo mật, tôi kết hợp chuyên môn kỹ thuật với khả năng giải quyết vấn đề sáng tạo để tạo ra các giải pháp hiệu quả.",
      }),
    ],
  });
}
const cd = (e) => {
  ...
  return r[t]
    ? r[t]
    : `https://cdn.jsdelivr.net/gh/devicons/devicon/icons/${t}/${t}-original.svg`;
};
  ...
  const { t: e, language: t } = Ut(),
    ...
    n = {
      languages: {
        ...
        desc:
          t === "en"
            ? "The foundation of my engineering."
            : "Nền tảng kỹ thuật của tôi.",
      ...
      tools: {
        ...
        desc:
          t === "en"
            ? "Ensuring reliability and deployment."
            : "Đảm bảo độ tin cậy và triển khai.",
    ...
    o = {
      ...
      "bottom-left":
        "lg:absolute lg:bottom-0 lg:left-4 lg:w-[45%] lg:text-right",
      "bottom-right":
        "lg:absolute lg:bottom-0 lg:right-4 lg:w-[45%] lg:text-left",
    },
    s = {
    ...
    l = {
      "bottom-right":
        'lg:after:content-[""] lg:after:absolute lg:after:top-full lg:after:left-full lg:after:w-20 lg:after:h-20 lg:after:border-t lg:after:border-l lg:after:border-blue-500/20 lg:after:rounded-tl-3xl lg:after:-translate-x-4 lg:after:-translate-y-4',
      "bottom-left":
        'lg:after:content-[""] lg:after:absolute lg:after:top-full lg:after:right-full lg:after:w-20 lg:after:h-20 lg:after:border-t lg:after:border-r lg:after:border-emerald-500/20 lg:after:rounded-tr-3xl lg:after:translate-x-4 lg:after:-translate-y-4',
      "top-right":
        'lg:after:content-[""] lg:after:absolute lg:after:bottom-full lg:after:left-full lg:after:w-20 lg:after:h-20 lg:after:border-b lg:after:border-l lg:after:border-orange-500/20 lg:after:rounded-bl-3xl lg:after:-translate-x-4 lg:after:translate-y-4',
      "top-left":
        'lg:after:content-[""] lg:after:absolute lg:after:bottom-full lg:after:right-full lg:after:w-20 lg:after:h-20 lg:after:border-b lg:after:border-r lg:after:border-violet-500/20 lg:after:rounded-br-3xl lg:after:translate-x-4 lg:after:translate-y-4',
    };
  return a.jsxs("section", {
    id: "skills",
    ...
    children: [
      a.jsx("div", {
        className:
          "absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none",
      }),
      a.jsx("div", {
        className:
          "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[100px] pointer-events-none",
      }),
      a.jsxs("div", {
        ...
        children: [
          a.jsxs("div", {
            ...
            children: [
              a.jsxs(P.div, {
                ...
                className:
                  "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-muted-foreground mb-4 uppercase tracking-widest",
                children: [
                  a.jsx(ui, {
          ...
          a.jsxs("div", {
            className:
              "relative min-h-[900px] lg:min-h-[500px] flex flex-col lg:block items-center justify-center",
            children: [
              a.jsxs("svg", {
                className:
                  "hidden lg:block absolute inset-0 w-full h-full pointer-events-none z-0 overflow-visible",
                children: [
                  a.jsxs("defs", {
                    children: [
                    ...
                    `,
                          ...
                          a.jsxs("div", {
                            children: [
                              ...
                              a.jsx("p", {
                                className:
                                  "text-xs text-muted-foreground font-mono uppercase tracking-widest",
                                children: h.desc,
                              }),
                            ],
                          }),
                        ...
                        `,
                                  ...
                                  a.jsx("div", {
                                    ...
                                    children: a.jsx(dd, {
                                      ...
                                      size: 40,
                                      className:
                                        "group-hover/node:scale-110 transition-transform duration-300",
                                    }),
                                  }),
                                  a.jsx("span", {
                                    className:
                                      "text-xs font-bold text-muted-foreground group-hover/node:text-foreground text-center relative z-10 uppercase tracking-tight",
                                    children: u,
                                  }),
                                ],
                              }),
          ...
          a.jsx(P.div, {
            ...
            children: a.jsx("div", {
              className:
                "inline-flex flex-wrap justify-center gap-1 p-2 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-md shadow-2xl",
              children: [
                e("tech.development"),
                e("tech.data"),
                e("tech.web"),
                ...
                a.jsx(
                  P.span,
                  {
                    ...
                    className:
                      "px-4 py-2 text-xs font-mono text-muted-foreground border-r border-white/5 last:border-0 hover:text-foreground transition-colors cursor-default",
                    children: c,
                  },
                  d,
                ),
    ...
    n = [
      {
        ...
        description:
          e === "en"
            ...
            : "Đào tạo toàn diện về nền tảng và ứng dụng AI",
      ...
      },
      {
        ...
        description:
          e === "en"
            ? "Security practices for business protection"
            : "Thực hành bảo mật cho doanh nghiệp",
        orientation: "landscape",
      },
      {
        ...
        description:
          e === "en"
            ...
            : "Xây dựng và triển khai mô hình ML trong sản xuất",
        orientation: "landscape",
      },
      {
        title: "Fundamentals of Machine Learning and AI",
        image:
          "/certificates/Fundamentals of Machine Learning and Artificial Intelligence.jpg",
        description:
          e === "en"
            ? "Core concepts of ML and AI technologies"
            : "Khái niệm cốt lõi về công nghệ ML và AI",
        orientation: "landscape",
      },
      {
        ...
        description:
          e === "en"
            ? "Protecting information assets and systems"
            : "Bảo vệ tài sản thông tin và hệ thống",
      ...
      },
      {
        ...
        description:
          e === "en"
            ...
            : "Khám phá nguyên lý và ứng dụng điện toán lượng tử",
        orientation: "portrait",
      },
      {
        ...
        description:
          e === "en"
            ...
            : "Bảo mật cơ sở hạ tầng mạng và truyền thông",
        orientation: "landscape",
      },
    ],
    o = t ? n : n.slice(0, 3);
      ...
      children: [
        a.jsxs(P.div, {
          ...
          children: [
            a.jsxs("div", {
              className:
                "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-mono mb-4 uppercase tracking-widest",
              children: [
                a.jsx(ri, {
                  className: "w-3 h-3",
                }),
            ...
            a.jsx("p", {
              ...
              children:
                e === "en"
                  ? "Milestones in my professional learning journey"
                  : "Những cột mốc quan trọng trong hành trình học tập chuyên nghiệp",
            }),
          ],
        }),
        a.jsx("div", {
          ...
          children: o.map((s, i) =>
            a.jsx(
              P.div,
              {
                ...
                children: a.jsx(ct, {
                  className:
                    "neon-border overflow-hidden bg-card/40 backdrop-blur-sm hover:bg-card/60 transition-all duration-300 group",
                  children: a.jsxs(dt, {
                    className: "p-0",
                    children: [
                      a.jsxs("div", {
                        ...
                        children: [
                          ...
                          a.jsx("div", {
                            className:
                              "absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300",
                          }),
                        ],
                      }),
                      a.jsxs("div", {
          ...
          a.jsx(P.div, {
            ...
            children: a.jsx(P.div, {
              ...
              children: a.jsx(Ft, {
                ...
                onClick: () => r(!t),
                className:
                  "bg-gradient-to-r from-primary to-accent hover:from-primary/80 hover:to-accent/80 text-white font-bold px-8 py-6 text-base shadow-[0_0_30px_rgba(59,130,246,0.5)] hover:shadow-[0_0_50px_rgba(59,130,246,0.8)] transition-all duration-300",
                children: a.jsx("span", {
                  ...
                  children: t
                    ...
                    : a.jsxs(a.Fragment, {
                        children: [
                          ...
                          e === "en"
                            ? `View All Certificates (${n.length})`
                            : `Xem tất cả chứng chỉ (${n.length})`,
                        ],
                      }),
                }),
              }),
...
function fd() {
  const { t: e, language: t } = Ut(),
    r =
      t === "en"
        ? "Ngo Quang Duan | Developer"
        : "Ngo Quang Duan | Lập trình viên",
    n =
      t === "en"
        ? "Ngo Quang Duan - Young developer specializing in automation, reverse engineering and security research. Explore creative projects and technology solutions."
        : "Ngo Quang Duan - Lập trình viên trẻ chuyên về tự động hóa, reverse engineering và nghiên cứu bảo mật. Khám phá các dự án sáng tạo và giải pháp công nghệ.",
    ...
    i = [
      {
        ...
        description:
          "A powerful analysis toolkit specifically designed for researching and recovering source code from executable files (.exe) packaged with PyInstaller",
      ...
      },
      {
        ...
        description:
          "Automated TikTok account registration tool using Selenium with proxy support and multi-threading capabilities for efficient bulk account creation",
  ...
  return a.jsxs("div", {
    ...
    children: [
      a.jsx(ks, {
        ...
        description: n,
        keywords:
          "Ngo Quang Duan, Ngo Quang Duan, developer, automation, reverse engineering, security research, TikTok automation, EXE2PY, tooldecexe",
      }),
      a.jsx(id, {
        type: "Person",
        name: o,
                ...
                a.jsxs(
                  P.a,
                  {
                    ...
                    children: [
                      ...
                      a.jsx(P.div, {
                        className:
                          "absolute -bottom-1 left-0 w-full h-0.5 bg-primary origin-left",
                        initial: {
                          scaleX: 0,
                        },
                        whileHover: {
            ...
            a.jsxs("div", {
              ...
              children: [
                a.jsx(P.div, {
                  ...
                  children: a.jsx(ct, {
                    className:
                      "neon-border-enhanced bg-gradient-to-br from-card/60 via-card/40 to-primary/5 backdrop-blur-sm border-primary/20 interactive-element smooth-transition",
                    children: a.jsx(dt, {
                      className: "p-8",
                      children: a.jsxs("div", {
                        className: "space-y-4",
                        children: [
                          ...
                          a.jsx("div", {
                            className:
                              "bg-primary/5 border-l-4 border-primary p-4 rounded-r-lg",
                            children: a.jsx("p", {
                          ...
                          a.jsxs("div", {
                            ...
                            children: [
                              ...
                              a.jsx("div", {
                                className:
                                  "bg-accent/10 border border-accent/20 p-3 rounded-lg",
                                children: a.jsx("p", {
                                  className:
                                    "text-accent font-medium text-center",
                              ...
                              a.jsxs("li", {
                                children: [
                                  ...
                                  t === "en"
                                    ...
                                    : "Xây dựng cầu nối giữa ý tưởng và thực tế",
                                ],
                              }),
                              a.jsxs("li", {
                                children: [
                                  ...
                                  t === "en"
                                    ...
                                    : "Tạo ra những kết nối có ý nghĩa thông qua code",
                                ],
                              }),
                              a.jsxs("li", {
                                children: [
                                  "• ",
                                  t === "en"
                                    ? "Understanding problems before crafting solutions"
                                    : "Hiểu vấn đề trước khi tạo ra giải pháp",
                                ],
                              }),
                              a.jsxs("li", {
                                children: [
                                  "• ",
                                  t === "en"
                                    ? "Fostering communities that grow together"
                                    : "Nuôi dưỡng những cộng đồng cùng phát triển",
                                ],
                              }),
                            ],
                          }),
              ...
              children: i.map((c, d) =>
                a.jsx(
                  P.div,
                  {
                    ...
                    children: a.jsx(ct, {
                      className:
                        "neon-border overflow-hidden bg-card/40 backdrop-blur-sm hover:bg-card/60 transition-all duration-300 h-full flex flex-col",
                      children: a.jsxs(dt, {
                        ...
                        children: [
                              ...
                              a.jsx(
                                P.div,
                                {
                                  ...
                                  children: a.jsx(zr, {
                                    variant: "secondary",
                                    className:
                                      "bg-primary/15 hover:bg-primary/25 text-primary border border-primary/20 px-3 py-1 text-sm font-medium transition-all duration-200",
                                    children: h,
                                  }),
                                },
                                h,
                          ...
                          a.jsx(P.div, {
                            ...
                            children: a.jsx(Ft, {
                              ...
                              size: "lg",
                              className:
                                "w-full neon-border btn-enhanced hover:bg-primary/10 hover:border-primary/50 transition-all duration-300 smooth-hover",
                              asChild: !0,
                              children: a.jsxs("a", {
                                href: c.github,
                                target: "_blank",
              ...
              children: [
                ...
                a.jsx(P.div, {
                  ...
                  children: a.jsx(Ft, {
                    size: "lg",
                    className:
                      "bg-gradient-to-r from-primary to-accent hover:from-primary/80 hover:to-accent/80 px-8",
                    asChild: !0,
                    children: a.jsxs("a", {
                      href: "https://github.com/hiep-py",
                      target: "_blank",
        ...
        children: a.jsxs("div", {
          ...
          children: [
            ...
            a.jsx(P.div, {
              ...
              children: l.map(({ icon: c, href: d, labelKey: h }) =>
                a.jsxs(
                  P.a,
                  {
                    href: d,
                    ...
                    className:
                      "flex items-center space-x-3 p-4 rounded-lg border border-border hover:border-primary transition-colors neon-border bg-card/50 backdrop-blur-sm",
                    children: [
                      a.jsx(c, {
                        size: 24,
                ...
                a.jsxs("div", {
                  children: [
                    ...
                    a.jsx("p", {
                      ...
                      children:
                        t === "en"
                          ? "Young developer specializing in automation, machine learning and security research."
                          : "Lập trình viên trẻ chuyên về tự động hóa, học máy và nghiên cứu bảo mật.",
                    }),
                    a.jsx("div", {
                    ...
                    a.jsxs("div", {
                      ...
                      children: [
                        a.jsx("a", {
                          ...
                          className:
                            "text-sm text-muted-foreground hover:text-primary transition-colors block",
              ...
              a.jsx($s, {
                children: a.jsxs(zs, {
                  children: [
                    ...
                    a.jsx(bn, {
                      path: "*",
                      element: a.jsx(fd, {}), // Redirect all non-existent routes to home
                    }),
                  ],
                }),
              }),
